...
I collected data each week on the amount of time I spend on schoolwork. Starting from 4/18/2025 to 5/18/2025 I timed how much time I spend on homework each day using a stopwatch on my phone. I then transferred the data to excel and used that data to visualize it using r studio. This code displayed visualizes the time I spend on school work each day of the week. I created a  plot where the day of week is on the x-axis and time spent on homework is on the y-axis. The jittered points represent individually time spent each day. The red points represent the mean time spent on school work  for each week day.
